...
public class ShowHomeDataActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICK_DIRECTORY && resultCode == RESULT_OK) {
            ...
            if (treeUri != null) {
                ...
                extractDataToCsv(getAllHomeData(), treeUri);
            }
        }
    }
    ...
    private void calculateTotalAmount() {
        ...
        for (String rowData : dataList) {
            ...
            if (values.length > 4) {
                ...
                String masjidAmountString = values[3].trim();
                String madrassaAmountString = values[4].trim();
    ...
    private void extractDataToCsv(List<String> dataList, Uri treeUri) {
        try {
            ...
            String displayName = "Home_data.csv";
